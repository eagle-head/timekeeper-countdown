...
import { getCurrentTime, isHighResolutionTimeAvailable, getTimeProviderInfo } from '../time-providers'
...
describe('time-providers', () => {
  ...
  describe('getCurrentTime', () => {
    ...
    it('should work with performance.now() available', async () => {
      ...
      vi.resetModules()
      const { getCurrentTime: freshGetCurrentTime } = await import('../time-providers')
  ...
  describe('isHighResolutionTimeAvailable', () => {
    ...
    it('should return true when performance.now() is available and working', async () => {
      ...
      const { isHighResolutionTimeAvailable: freshIsHighRes } = await import('../time-providers')
  ...
  describe('getTimeProviderInfo', () => {
    ...
    it('should return performance type when performance.now() is available', async () => {
      ...
      const { getTimeProviderInfo: freshGetInfo } = await import('../time-providers')
